...
const CONTRASTS: Contrast[] = [
  {
    ...
    body: "A general chatbot answers and moves on. Clarify.AI is built around the re-explain ladder: it assumes the first explanation may not land, and it stays with you, a different way each time, until one does.",
  },
  {
    them: "They aim to sound right.",
    thisOne: "This one checks.",
    body: "Clarify.AI runs a second examiner pass over its own finished work, grades its own arithmetic by plugging results back in, and cites sources when it searches. Caring about a student means checking before handing back the answer.",
  },
  {
...
const BENCHMARK_NOTE =
  "One number, with its provenance attached: in blind evaluations Clarify.AI runs on itself, six independent AI judges score it against eight other systems on real board-exam questions, and in the latest run its accuracy score, 9.62 out of 10, was the highest of all nine systems on the panel, the biggest general AIs included.";
...
export default function WhySection() {
  ...
  return (
    <section
      ...
      aria-label="How Clarify.AI is different from a general chatbot"
    >
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] lg:gap-16">
          <div className="lg:sticky lg:top-16">
            ...
            <p className="landing-pretty mt-5 max-w-lg text-[15px] leading-relaxed text-ink-dim md:text-base">
              ...
              about everything, once. Clarify.AI was built to look after one
