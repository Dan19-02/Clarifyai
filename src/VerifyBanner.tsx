...
export default function VerifyBanner() {
  ...
  const hindi = /hindi|hinglish/i.test(account.profile?.language || "");
      ...
      <div className="mx-auto flex max-w-3xl flex-col gap-2">
        <div className="flex items-center gap-2.5 text-xs sm:text-sm">
          ...
          <span className="flex-1">
            ...
            {hindi && <span className="block text-[11px] text-amber-800/80">अपना अकाउंट सुरक्षित करने के लिए ईमेल वेरिफ़ाई करें।</span>}
          </span>
          {!open && (
            <button
